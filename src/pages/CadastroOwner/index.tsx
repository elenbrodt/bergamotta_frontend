    ...
    <div>
      ...
      <form className='cadastro-owner'>
        ...
        <div className='inputs-especificos'>
          <div>
            <p>CNPJ</p>
            <input type="text" placeholder="digite seu CNPJ" className='config-input-secondary cnpj' />
          </div>
          <div>
            <p>Ocupação</p>
        ...
        <div className='inputs-especificos-secondary'>
          <div>
            <p>Cidade</p>
            <input type="text" placeholder="cidade" className='config-input-tertiary cidade' />
          </div>
          <div>
            <p>UF</p>
            <input type="text" placeholder=" UF" className='config-input-tertiary' />
          </div>
          <div>
            <p>País</p>
            <input type="text" placeholder=" País" className='config-input-tertiary' />
          </div>
        </div>
